...
import * as Kit from 'mHealthBankMobile/src/components/Kit'
    ...
    renderIOS() {
        ...
        return (
            <View style={[
                ...
                styles.container,
                this.props.outlined && styles.outline,
                { alignItems: this.props.textAlignPlaceholder ? this.props.textAlignPlaceholder : Platform.OS == 'ios' ? 'flex-end' : 'stretch' },
                { ...this.props.style }]}>
                <TouchableOpacity
